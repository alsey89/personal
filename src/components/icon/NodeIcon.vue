<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="52.18" height="32" viewBox="0 0 512 314">
        <defs>
        ...
        <g fill="none">
            ...
            <g transform="translate(134.068 70.501)">
                ...
                <g mask="url(#logosNodejs8)">
                    <path
                        d="M109.797 91.305V35.019c0-2.08-1.271-4.045-3.12-5.085L57.786 1.85a5.106 5.106 0 0 0-1.848-.693l53.511 91.42c.231-.347.347-.809.347-1.271M3.12 29.934C1.272 30.974 0 32.94 0 35.02v56.286c0 2.08 1.387 4.045 3.12 5.085l48.889 28.085c1.156.693 2.427.925 3.814.693L3.467 29.818z" />
